...
var require_dist2 = __commonJS({
  "node_modules/json5/dist/index.js"(exports, module2) {
    (function(global3, factory2) {
      typeof exports === "object" && typeof module2 !== "undefined" ? module2.exports = factory2() : typeof define === "function" && define.amd ? define(factory2) : global3.JSON5 = factory2();
    })(exports, function() {
      "use strict";
...
var require_duration = __commonJS({
  "node_modules/dayjs/plugin/duration.js"(exports, module2) {
    !function(t2, s) {
      typeof exports == "object" && typeof module2 != "undefined" ? module2.exports = s() : typeof define == "function" && define.amd ? define(s) : (t2 = typeof globalThis != "undefined" ? globalThis : t2 || self).dayjs_plugin_duration = s();
    }(exports, function() {
      "use strict";
...
var require_utils = __commonJS({
  "fronts/utils.js"(exports, module2) {
...
var require_html_tags_void = __commonJS({
  "node_modules/html-tags/html-tags-void.json"(exports, module2) {
    module2.exports = [
      "area",
      "base",
      "br",
...
var require_void = __commonJS({
  "node_modules/html-tags/void.js"(exports, module2) {
    "use strict";
    module2.exports = require_html_tags_void();
  }
});
...
var require_diff = __commonJS({
  "node_modules/deep-object-diff/dist/diff/index.js"(exports, module2) {
    (function(global3, factory2) {
      if (typeof define === "function" && define.amd) {
        define(["module", "exports", "../utils"], factory2);
      } else if (typeof exports !== "undefined") {
        factory2(module2, exports, require_utils2());
      } else {
        var mod = {
          exports: {}
        };
...
var require_added = __commonJS({
  "node_modules/deep-object-diff/dist/added/index.js"(exports, module2) {
    (function(global3, factory2) {
      if (typeof define === "function" && define.amd) {
        define(["module", "exports", "../utils"], factory2);
      } else if (typeof exports !== "undefined") {
...
var require_deleted = __commonJS({
  "node_modules/deep-object-diff/dist/deleted/index.js"(exports, module2) {
    (function(global3, factory2) {
      if (typeof define === "function" && define.amd) {
        define(["module", "exports", "../utils"], factory2);
      } else if (typeof exports !== "undefined") {
...
var require_updated = __commonJS({
  "node_modules/deep-object-diff/dist/updated/index.js"(exports, module2) {
    (function(global3, factory2) {
      if (typeof define === "function" && define.amd) {
        define(["module", "exports", "../utils"], factory2);
      } else if (typeof exports !== "undefined") {
...
var require_detailed = __commonJS({
  "node_modules/deep-object-diff/dist/detailed/index.js"(exports, module2) {
    (function(global3, factory2) {
      if (typeof define === "function" && define.amd) {
        define(["module", "exports", "../added", "../deleted", "../updated"], factory2);
      } else if (typeof exports !== "undefined") {
        factory2(module2, exports, require_added(), require_deleted(), require_updated());
      } else {
        var mod = {
          exports: {}
        };
...
__export(exports, {
  ...
  U: () => U,
  UTILS: () => UTILS,
  addedDiff: () => import_deep_object_diff.addedDiff,
  attr2Str: () => attr2Str,
  awaitTo: () => awaitTo,
  buildAsyncPipe: () => buildAsyncPipe,
  camel2hyphen: () => camel2hyphen,
  camelNameToCls: () => camelNameToCls,
  cid: () => cid,
  comHelper: () => comHelper,
  ...
  deletedDiff: () => import_deep_object_diff.deletedDiff,
  detailedDiff: () => import_deep_object_diff.detailedDiff,
  diff: () => import_deep_object_diff.diff,
  fetchContentV3: () => fetchContentV3,
  formModel: () => formModel,
  getHereDoc: () => getHereDoc,
  getObjParentPathFromPathArr: () => getObjParentPathFromPathArr,
  getObjPathFromPathArr: () => getObjPathFromPathArr,
  getStrFromObj: () => getStrFromObj,
  global: () => global2,
  importJsStr: () => importJsStr,
  initTemplate: () => initTemplate,
  isNumeric: () => isNumeric,
  lodash: () => lodash,
  nid: () => nid,
  rid: () => rid,
  rmObjProps: () => rmObjProps,
  rmPropByPath: () => rmPropByPath,
  sleep: () => sleep,
  structuralClone: () => structuralClone,
  updatedDiff: () => import_deep_object_diff.updatedDiff,
  uuid: () => uuid
});
...
var Lock = class {
  ...
  lock(task, timeout = 6e4) {
    return __async(this, null, function* () {
      ...
      if (this[PRIVATE.locked]) {
        yield new Promise((resolve, reject3) => {
  ...
  static all(locks, task, timeout = 6e4) {
    return __async(this, null, function* () {
...
_U.awaitAxios = function(p) {
  return __async(this, null, function* () {
    var _a;
    let [err, response] = yield ZY.awaitTo(p);
    return {
